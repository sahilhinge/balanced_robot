...
const int rxpin = 0; // pin used to receive (not used in this version) 
const int txpin = 1; // pin used to send to LCD
...
#define BALANCE_KP 37            // PID Constants
#define BALANCE_KI 210
#define BALANCE_KD 1.5
...
#define ROTATION_KI 0.5
#define ROTATION_KD 0

#define MOTOR_A_DIR      5         //M11
#define MOTOR_A_BRAKE    6        //M12
#define MOTOR_B_DIR      7        //M21
#define MOTOR_B_BRAKE    8       //M22
...
#define PWM_MIN 0
#define PWM_MAX 255
float MOTORSLACK_A=30;                     // Compensate for motor slack range (low PWM values which result in no motor engagement)
float MOTORSLACK_B=30;                     // Compensate for motor slack range (low PWM values which result in no motor engagement)
...
void init_imu()
{
    ...
    mpu.setXAccelOffset(726);
    mpu.setYAccelOffset(-3955);
